...
xgb_model.fit(X_train, y_train, eval_set=[(X_dev, y_dev)], early_stopping_rounds=10, verbose=False)

# Save the model (optional)
# joblib.dump(xgb_model, r"C:\Users\tarun\OneDrive\Desktop\best_model_XGBoast_main.pkl")
